...
class TestImaginaryGaussianRing:
    @hyp.given(
        decay_time = st.floats(min_value = 0, allow_nan = False, allow_infinity = False),
    )
    ...
    @hyp.given(
        decay_time = st.floats(max_value = 0, allow_nan = False, allow_infinity = False),
    )
    ...
    @hyp.given(
        center = st.floats(min_value = 0, allow_nan = False, allow_infinity = False),
    )
    def test_center_can_be_non_negative(self, center):
        ion.potentials.ImaginaryGaussianRing(center = center)

    @hyp.given(
        center = st.floats(max_value = 0, allow_nan = False, allow_infinity = False),
    )
    ...
    @hyp.given(
        width = st.floats(max_value = 0, allow_nan = False, allow_infinity = False),
    )
