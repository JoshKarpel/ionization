...
def test_can_construct_radial_cosine_mask_with_positive_inner_radius(inner_radius):
    ...
    ion.potentials.RadialCosineMask(inner_radius = inner_radius, outer_radius = outer_radius)
...
def test_radial_cosine_mask_is_one_at_inner_radius(outer_radius):
    ...
    mask = ion.potentials.RadialCosineMask(inner_radius = inner_radius, outer_radius = outer_radius)
