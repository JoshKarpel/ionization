...
if __name__ == '__main__':
    with logman as logger:
        ...
        for evol_method, int_method in itertools.product(evol_methods, int_methods):
            specs.append(ide.IntegroDifferentialEquationSpecification('int={}_evol={}'.format(int_method, evol_method),
        ...
        si.vis.xxyy_plot(
                f'method_comparison__pw={uround(pw, asec, 3)}_dt={uround(dt, asec, 3)}',
