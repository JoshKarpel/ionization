...
if __name__ == '__main__':
    ...
    with logman as logger:
        ...
        kernel_hydrogen_func = sym.lambdify((a, m, hb, t), kernel_hydrogen_func, modules = ['numpy', {'erfc': special.erfc}])
        print(kernel_hydrogen_func)
        ...
        kernel_gaussian = gau_kern_prefactor * ide.gaussian_kernel_LEN(td, tau_alpha = ide.gaussian_tau_alpha_LEN(test_width, test_mass))
        ...
        kernel_hydrogen_func = functools.partial(kernel_hydrogen_func, bohr_radius, electron_mass, hbar)
        ...
        kernel_hydrogen_func_shifted = lambda t: kernel_hydrogen_func(t + .01 * asec)
        ...
        specs = [
            ...
            ide.IntegroDifferentialEquationSpecification(
                ...
                prefactor = - ((proton_charge / hbar) ** 2) * hyd_kern_prefactor,
                **shared_kwargs
            )
        ]
