...
if __name__ == '__main__':
    with si.utils.LogManager('simulacra', 'ionization', stdout_logs = True, stdout_level = logging.DEBUG) as logger:
        ...
        for amp in (1, 2):
            for period in (100, 200):
                for state in states:
                    ...
                    animators = [src.ionization.animators.SphericalSliceAnimator(target_dir = OUT_DIR),
                                 # ion.animators.SphericalSliceAnimator(postfix = 'log', target_dir = OUT_DIR, log = True, renormalize = False),
                                 src.ionization.animators.SphericalSliceAnimator(postfix = '30', target_dir = OUT_DIR, plot_limit = 30 * bohr_radius),
                                 src.ionization.animators.SphericalSliceAnimator(postfix = '100', target_dir = OUT_DIR, plot_limit = 100 * bohr_radius)
                                 ]
                    ...
                    animators = [src.ionization.animators.SphericalHarmonicAnimator(target_dir = OUT_DIR),
                                 # ion.animators.SphericalHarmonicAnimator(postfix = 'log', target_dir = OUT_DIR, log = True, renormalize = False),
                                 src.ionization.animators.SphericalHarmonicAnimator(postfix = '30', target_dir = OUT_DIR, plot_limit = 30 * bohr_radius),
                                 src.ionization.animators.SphericalHarmonicAnimator(postfix = '100', target_dir = OUT_DIR, plot_limit = 100 * bohr_radius)
                                 ]
        ...
        si.utils.multi_map(make_movie, specs, processes = 3)
