        ...
        for initial_state in initial_states:
            for pulse_width in pulse_widths:
                for fluence in fluences:
                    ...
                    animators = [src.ionization.animators.SphericalHarmonicAnimator(target_dir = out_dir_mod),
                                 src.ionization.animators.SphericalHarmonicAnimator(target_dir = out_dir_mod, plot_limit = 30 * bohr_radius, postfix = '_lim=30'),
                                 src.ionization.animators.SphericalHarmonicAnimator(target_dir = out_dir_mod, plot_limit = 100 * bohr_radius, postfix = '_lim=100'),
                                 ]
