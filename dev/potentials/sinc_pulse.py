            ...
            for pulse_width in pulse_widths:
                for fluence in fluences:
                    ...
                    mask = ion.RadialCosineMask(
                        inner_radius=(bound - 25) * bohr_radius,
                        outer_radius=bound * bohr_radius,
                    )

                    out_dir_add = "bounds_r={}_l={}__n={}_l={}__flu={}".format(
                        bound, l_bound, initial_state.n, initial_state.l, fluence
                    )
