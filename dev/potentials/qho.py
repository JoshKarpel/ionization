...
if __name__ == '__main__':
    with si.utils.LogManager('simulacra', 'ionization', stdout_level = logging.INFO) as logger:
        ...
        ani = [
            ...
            src.ionization.animators.LineAnimator(target_dir = OUT_DIR, postfix = '_full_log', log_metrics = True),
            src.ionization.animators.LineAnimator(target_dir = OUT_DIR, plot_limit = 10 * nm, postfix = '_10'),
        ]
