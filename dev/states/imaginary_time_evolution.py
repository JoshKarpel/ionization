    ...
    with si.utils.LogManager(
        ...
        for im_time_step in im_time_steps:
            sim = ion.SphericalHarmonicSpecification(
                "imag_{}".format(im_time_step),
                **spec_kwargs,
                find_numerical_ground_state=True,
                imaginary_time_evolution_steps=im_time_step
            ).to_sim()

            g_discrete = sim.mesh.g_mesh[0, :] / sim.mesh.norm
            g_analytic = (
                sim.spec.initial_state.radial_function(sim.mesh.r)
                * sim.mesh.r
                / sim.mesh.norm
            )
            ...
            pre_post_fractional_difference = (
                np.abs(g_pre) ** 2 - np.abs(g_post) ** 2
            ) / np.abs(g_pre) ** 2

            pre_post_differences.append(pre_post_difference)
            pre_post_fractional_differences.append(pre_post_fractional_difference)

            # si.utils.xy_plot('g_fractional_difference_log_{}'.format(im_time_step),
            ...
            #                  target_dir = OUT_DIR)
            #
            # si.utils.xy_plot('g_fractional_difference_log_log_{}'.format(im_time_step),
            #                  imag.mesh.r, fractional_difference,
            #                  x_unit = 'bohr_radius', x_label = r'$r$', y_label = r'$\left| \frac{g_{\mathrm{discrete}} - g_{\mathrm{analytic}}}{g_{\mathrm{analytic}}} \right|$',
        ...
        si.vis.xy_plot(
            "g_difference_lin_log",
            sim.mesh.r,
            *differences,
            line_labels=labels,
            x_unit="bohr_radius",
            x_label=r"$r$",
            y_label=r"$\left| g_{\mathrm{discrete}} - g_{\mathrm{analytic}} \right|$",
            y_log_axis=False,
            x_log_axis=True,
            target_dir=OUT_DIR
        )
        ...
        si.vis.xy_plot(
            "g_fractional_difference_log",
            sim.mesh.r,
            *fractional_differences,
            line_labels=labels,
            x_unit="bohr_radius",
            x_label=r"$r$",
            y_label=r"$\left| \frac{g_{\mathrm{discrete}} - g_{\mathrm{analytic}}}{g_{\mathrm{analytic}}} \right|$",
            y_log_axis=True,
            x_log_axis=False,
            target_dir=OUT_DIR
        )
        ...
        si.vis.xy_plot(
            "g_fractional_difference_log_log",
            sim.mesh.r,
            *fractional_differences,
            line_labels=labels,
            x_unit="bohr_radius",
        ...
        si.vis.xy_plot(
            "evolved_g_difference_lin_log",
            sim.mesh.r,
            *pre_post_differences,
            line_labels=labels,
            x_unit="bohr_radius",
            x_label=r"$r$",
            y_label=r"$\left| g_{\mathrm{pre}} \right|^2  - \left|g_{\mathrm{post}} \right|^2$",
            y_log_axis=False,
            x_log_axis=True,
            target_dir=OUT_DIR
        )
        ...
        si.vis.xy_plot(
            "evolved_g_fractional_difference_log",
            sim.mesh.r,
            *pre_post_fractional_differences,
            line_labels=labels,
            x_unit="bohr_radius",
            x_label=r"$r$",
            y_label=r"$\frac{ \left| g_{\mathrm{pre}} \right|^2  - \left|g_{\mathrm{post}} \right|^2 }{\left| g_{\mathrm{pre}} \right|^2}$",
            y_log_axis=True,
            x_log_axis=False,
            target_dir=OUT_DIR
        )
        ...
        si.vis.xy_plot(
            "evolved_g_fractional_difference_log_log",
            sim.mesh.r,
            *pre_post_fractional_differences,
            line_labels=labels,
            x_unit="bohr_radius",
