    ...
    with log as logger:
        ...
        for pulse_width in (50, 100, 200, 500, 1000):
            ...
            si.plots.xy_plot('pw={}as_flu={}Jcm2_integrated'.format(pulse_width, fluence),
                             ...
                             gaus_cos.get_electric_field_integral_numeric(times) * field_prefactor,
                             gaus_sin.get_electric_field_integral_numeric(times) * field_prefactor,
                             sech_cos.get_electric_field_integral_numeric(times) * field_prefactor,
                             sech_sin.get_electric_field_integral_numeric(times) * field_prefactor,
                             line_labels = (r'Sinc $\varphi = 0$',
                                            r'Sinc $\varphi = \pi/2$',
                                            r'Gaussian $\varphi = 0$',
                                            r'Gaussian $\varphi = \pi/2$',
