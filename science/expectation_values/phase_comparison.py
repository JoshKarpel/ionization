...
if __name__ == "__main__":
    with LOGMAN as logger:
        ...
        tex_labels = [
            r"$"
            + r.name[r.name.find("cep") :]
            .replace("cep", r"\varphi")
            .replace("pi", r"\pi")
            + "$"
            for r in results
        ]
        ...
        si.vis.xxyy_plot(
            ...
            [
                *[
                    sum(r.state_overlaps_vs_time[state] for state in r.bound_states)
                    for r in results
                ]
            ],
            line_labels=tex_labels,
        ...
        si.vis.xxyy_plot(
            ...
            x_label="$t$",
            x_unit="asec",
            y_label=r"$ \left\langle r(t) \right\rangle $",
            y_unit=bohr_radius,
        ...
        si.vis.xxyy_plot(
            ...
            x_label="$t$",
            x_unit="asec",
            y_label=r"$ \left\langle d(t) \right\rangle $",
