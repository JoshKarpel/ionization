...
if __name__ == "__main__":
    with LOGMAN as logger:
        ...
        si.vis.xy_plot(
            ...
            x_unit="asec",
            y_label=r"$ K(t-t') $",
            vlines=[imag_zero_at, real_zero_at, 44.005 * asec],
            **PLOT_KWARGS,
        )
        ...
        max_ionization_at = (
            optim.minimize_scalar(
                lambda td: functools.partial(analytic_b2, eta=eta, omega=omega)(
                    td * asec
                ),
                bracket=[80, 100],
            ).x
        ...
        zero_diff_at = (
            optim.brentq(
                lambda td: functools.partial(analytic_b2_m_lim, eta=eta, omega=omega)(
                    td * asec
                ),
                10,
                100,
        ...
        print(
            ...
            (akv.real ** 2) + (2 * akv.real) + (akv.imag ** 2),
        )
