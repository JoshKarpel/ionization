...
if __name__ == "__main__":
    with LOGMAN as logger:
        ...
        pulse = ion.potentials.SincPulse(
            ...
            fluence=1 * u.Jcm2,
            phase=u.pi / 3,
            window=potentials.LogisticWindow(window_time=30 * pw, window_width=pw / 5),
        )
        ...
        si.vis.xy_plot(
            ...
            line_labels=[r"original", r"corrected", r"correction"],
            line_kwargs=[{"linestyle": "-"}, {"linestyle": "--"}, {"linestyle": ":"}],
            x_unit="asec",
