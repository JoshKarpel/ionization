...
if __name__ == '__main__':
    with si.utils.LogManager('simulacra', 'ionization') as logger:
        jp_names = [
            'dense_fluences__hyd__100-200-400as__sine_and_cosine.job',
        ]
        for jp_name in jp_names:
            ...
            print(results)
            for r in results:
                print(r.file_name, r.phase, r.pulse_width / asec, r.fluence / Jcm2, r.final_initial_state_overlap, r.final_bound_state_overlap)
