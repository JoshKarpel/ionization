            ...
            for metric in metrics:
                for pulse_width, fluence in itertools.product(pulse_widths, fluences):
                    ...
                    si.vis.xxyy_plot(
                        ...
                        [
                            *[[get_omega_carrier(r) / twopi for r in jp.select_by_kwargs(phase = phase, **selector)] for phase in phases],
                        ],
                        [
                            *[[getattr(r, metric) for r in jp.select_by_kwargs(phase = phase, **selector)] for phase in phases],
                        ],
                        line_labels = [fr'$\varphi = {uround(phase, pi)}\pi$' for phase in phases],
                        x_label = r'$f_{\mathrm{carrier}}$', x_unit = 'THz',
                        # y_label = metric_name,
