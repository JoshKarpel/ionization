    ...
    with log as logger:
        ...
        for amplitude in amplitudes:
            for cycle in cycles:
                ...
                animators = [
                    src.ionization.animators.SphericalHarmonicAnimator(postfix = 'full', length = 30, **animator_kwargs),
                    src.ionization.animators.SphericalHarmonicAnimator(postfix = 'zoom_20_short', plot_limit = 20 * bohr_radius, length = 60, **animator_kwargs),
                    src.ionization.animators.SphericalHarmonicAnimator(postfix = 'zoom_20_long', plot_limit = 20 * bohr_radius, length = 120, **animator_kwargs),
                ]
