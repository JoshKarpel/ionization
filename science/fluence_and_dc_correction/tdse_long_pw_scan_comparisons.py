...
if __name__ == "__main__":
    with LOGMAN as logger:
        ...
        longer_jp = clu.JobProcessor.load(
            "job_processors/PAPER__tdse_pw_scan_longer.job"
        )
        longer_no_dc_jp = clu.JobProcessor.load(
            "job_processors/PAPER__tdse_pw_scan_longer_no_DC_correct.job"
        )
        longer_jp_with_fluence_and_dc = clu.JobProcessor.load(
            "job_processors/PAPER_OL_pw_scan_dc_and_flu_correction_tb=55.job"
        )
        ...
        fluences = set.intersection(
            *[jp.parameter_set("fluence") for jp in jp_to_label]
        )
        print(fluences)
            ...
            for phase in (0, u.pi / 2):
                jp_to_results = {
                    jp: sorted(
                        ...
                        [
                            r
                            for r in jp.select_by_kwargs(fluence=fluence, phase=phase)
                ...
                si.vis.xxyy_plot(
                    ...
                    y_data=[
                        [
                            ...
                            - br.final_initial_state_overlap
