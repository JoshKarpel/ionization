...
if __name__ == "__main__":
    with LOGMAN as logger:
        tunneling_models = [
            tunneling.LandauRate(upper_amplitude_cutoff=1 * u.atomic_electric_field),
        ...
        amplitudes = np.geomspace(0.04, 10, 1000) * u.atomic_electric_field
        ...
        si.vis.xy_plot(
            ...
            *tunneling_rates,
            ...
            x_log_axis=True,
            y_log_axis=True,
            y_lower_limit=0.001 / u.atomic_time,
